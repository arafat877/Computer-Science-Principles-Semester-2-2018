...
public class TestBook {
	...
	public static void main(String[] args) {
		...
		System.out.println("getAuthorName()= " + anotherBook.getAuthorName());
		System.out.println("getAuthorEmail()= " + anotherBook.getAuthorEmail());
		System.out.println("getAuthorGender()= " + anotherBook.getAuthorGender());
	}
